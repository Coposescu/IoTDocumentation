...
\renewcommand{\thesistitle}{Sistem de monitorizare temperatura si umiditate} % Titlul luucrării de licență
\renewcommand{\thesissupervisor}{titlul științific Prenume NUME} %% Conducătorul științific
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{enumerate}
	...
	\item {\bf Consultanți:}
	\item {\bf Data emiterii temei:} 1 Noiembrie 2023 %%%%%%%%%%%%% Modificați corespunzător
	\item {\bf Data predării:} 12 iulie 2024 %%%%%%%%%%%%%%% Modificați corespunzător
\end{enumerate}
\vspace{1.2cm}
