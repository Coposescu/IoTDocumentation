...
TCP/IP este stiva de comunicatie, un protocol, care sta la baza internetului si la baza interconectivitatii dispozitivelor. Majoritatea dispozitivelor 
...
pe 5 nivele unde fiecare nivel reprezinta un alt protocol de comunicatie. 

Figura \ref{fig:TCPIP_Layers} prezinta 

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.8]{figs/TCPIP_Layers.png}
    \caption{Arhitectura publica/aboneaza a protocolului MQTT [4]}
