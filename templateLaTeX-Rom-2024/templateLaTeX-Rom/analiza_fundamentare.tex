...
particularitatile sunt reprezentate prin biti sau set de biti. Mai jos sunt prezentate cele mai 
uzuale astfel de proprietati:
\begin{itemize}
...
Metodele definite de protocolul HTTP sunt prezentate in enumerarea urmatoare. O metoda reprezinta o actiune pe care un client o trimite unui server pentru 
a fi executata.
\begin{itemize}
	\item GET - 
	\item POST -
...
O adresa URL este compusa din trei parti principale. Acestea sunt enumerate mai jos:
\begin{itemize}
	\item Protocolul utilizat pentru extragerea resursei. De exemplu, http.
	\item Adresa serverului sau locatia serverului. De exempu, www.universitatea\_tehnica.ro.
	\item Identificatorul unic al resursei. De exemplu, clientID/1. 
\end{itemize}
