...
Pentru realizarea senzorului s-a utilizat platforma de dezvoltare Arty Z7 la care este conectat un controller de retea ATWINC1500, senzorul de temperatura 
si umiditate HDC1080, senzorul pentru compusii organici volatili SGP40 si senzorul pentru particulele in suspensie SPS30. Pentru realizarea schemei arhitecturale a fost 
utilizat mediul de dezvoltare Xilinx Vivado 2018.3, iar pentru dezvoltarea codului sursa in limbajul de programare C a fost utilizat mediul de dezvoltare Xilinx SDK 2018.3.

Figura \ref{fig:PI_SensorUnitDiagram} prezinta arhitectura modulului de achizitionare a indicilor de calitate a aerului.
\begin{figure}[H]
    \centering
...
Nucleul platformei de dezvoltare Arty Z7 este sistemul integrat Zynq7000 \cite{zynq7000ug585}, avand o multitudine de porturi si componente periferice pentru adaptarea la diferite 
proiecte. De pe aceasta platforma sunt utilizate cele doua porturi pmod si 5 pini de pe conectorii J2 si J7. Senzorii HDC1080 si SGP40 sunt conectati la portul pmodB, controllerul 
de retea ATWINC1500 este conectat la portul pmodA, iar senzorul SPS30 este conectat la conectorii J2 si J4. Sistemul integrat Zynq7000 reprezinta unitatea de control al tututor 
perifericelor de pe platforma si a portului MicroUSB utilizat pentru alimentarea cu 5 volti si pentru comunicatia cu un calculator personal prin interfata de comunicare UART.
...
senzorului SGP40 si fisierele "sps30.c" si "sps30.h" specifice senzorului SPS30 reprezinta un nivel de abstractizare al driver-ului oferot de Sensirion pentru acestia. 
...
Directorul "sensirion\_driver" reprezinta driver-ul pentru senzorii SGP40 si SPS30 oferit de compania Sensirion sub licenta libera. Acesta poate fi descarcat de pe site-ul 
oficial al companiei Sensirion. Fisierele "sensirion\_i2c.c" si "sensirion\_i2c.h" contin functii de tip stub pentru initializarea, scrierea si citirea peste interfata de 
comunicatie I2C. Aceste functii sunt de tipul stub, sunt specifice platformei in care este utilizat driver-ul si trebuie implementate de catre integrator. Fisierele 
"sensirion\_common.c" si "sensirion\_common.h" contin functii pentru diferite conversii intre tipuri de date, cum ar fi conversia din float in sir de octeti, functii pentru 
calcularea si verificarea octetului de verificare a integritatii pachetului (CRC) si functii pentru formatarea datelor care sunt scrise in sau citite din registrii celor 2 
senzori SGP40 si SPS30 conform cu structura acestora.

Directorul "sensirion\_gas\_index\_algorithm" contine algoritmul pentru interpretarea datelor citite de la senzorul SGP40 si este oferit de compania Sensirion sub licenta 
libera. Acest algoritm primeste ca intrare valorile brute citite de senzor in unitatea de masura micrometru sau parti pe milion si returneaza un indince al compusilor 
organici volatili. Sensirion ofera un cod de culori care corespunde cu valorile indicelui returnat de algoritm pentru interpretarea acestuia din punct de vedere al 
calitatii aerului. Algoritmul compenseaza variatia valorilor care exista intre senzorii SGP40, iar semnalul brut de intrare trebuie oferit la un interval constant de o 
secunda.
...
WINC1500-XPRO reprezinta o placa de extensie pentru modulul ATWINC1500 care ofera un conector de 20 de pini pentru a facilita integrarea acestuia cu un microcontroler 
